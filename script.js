...
const TRANSLATIONS = {
  it: {
    ...
    "hero.title": "Ogni film.<br>Ogni serie. Un solo universo.",
    ...
    "screenshots.calendar": "Calendario",
    "screenshots.profile": "Profilo",
    "screenshots.note": "Anteprime segnaposto — verranno sostituite con gli screenshot reali dell'app.",
    "faq.eyebrow": "FAQ",
  ...
  en: {
    ...
    "hero.title": "Every movie.<br>Every show. One universe.",
    ...
    "screenshots.note": "Placeholder previews — will be replaced with real app screenshots.",
    "faq.eyebrow": "FAQ",
  ...
  es: {
    ...
    "hero.title": "Cada película.<br>Cada serie. Un solo universo.",
    ...
    "screenshots.calendar": "Calendario",
    "screenshots.profile": "Perfil",
    "screenshots.note": "Vistas previas de muestra — se sustituirán por capturas reales de la app.",
    "faq.eyebrow": "FAQ",
  ...
  fr: {
    ...
    "hero.title": "Chaque film.<br>Chaque série. Un seul univers.",
    ...
    "screenshots.calendar": "Calendrier",
    "screenshots.profile": "Profil",
    "screenshots.note": "Aperçus provisoires — seront remplacés par de vraies captures de l'app.",
    "faq.eyebrow": "FAQ",
  ...
  de: {
    ...
    "hero.title": "Jeder Film.<br>Jede Serie. Ein Universum.",
    ...
    "screenshots.profile": "Profil",
    "screenshots.note": "Platzhalter-Vorschauen — werden später durch echte App-Screenshots ersetzt.",
    "faq.eyebrow": "FAQ",
